---
name: duckduckgo
description: Dynamic access to duckduckgo MCP server (1 tools)
version: 1.0.0
---

# duckduckgo Skill

This skill provides dynamic access to the duckduckgo MCP server without loading all tool definitions into context.
